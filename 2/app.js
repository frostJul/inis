...
function generateShirtProducts(shirts) {
    ...
    shirts.forEach(shirt => {
        ...
        seePageButton.addEventListener('click', () => openDetailsPage(shirt));
...
// Функция для открытия страницы деталей
function openDetailsPage(shirt) {
    // Сохраняем информацию о выбранной футболке в localStorage
